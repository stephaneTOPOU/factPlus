                                        ...
                                        @foreach ($proformats as $proformat)
                                            <li class="nav-item">
                                                <div class="nav-link list-actions"
                                                    id="{{ $proformat->reference_proformat }}"
                        ...
                        <div class="invoice-container">
                            <div class="invoice-inbox">
                                ...
                                <div class="inv-not-selected">
                                    <p>Ouvrez un proformat dans la liste.</p>
                                </div>
                                                ...
                                                <div class="row inv--detail-section">
                                                    ...
                                                    <div class="col-sm-5 align-self-center  text-sm-right order-2">
                                                        ...
                                                        <p class="inv-due-date"><span class="inv-title">Date
                                                            ...
                                                            <span
                                                                class="inv-date">{{ $proformat->date_echeance }}</span>
                                                        </p>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="inv--payment-info">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8 col-12">
                                                                    <p>
                                                                        {{ implode(' | ', $proformat->detailProformat->map(fn($detail) => $detail->produit->categorie . '; ' . $detail->produit->description)->toArray()) }}
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
