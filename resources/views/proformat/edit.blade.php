                                    ...
                                    <div class="form-group row  mb-4">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control form-control-sm"
                                                ...
                                                name="quantite" required @foreach ($proformat->detailProformat as $detail) value="{{ old('quantite') ?? $detail->quantite }}" @endforeach>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row  mb-4">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control form-control-sm"
                                                ...
                                                name="prix_unitaire" required @foreach ($proformat->detailProformat as $detail) value="{{ old('prix_unitaire') ?? $detail->prix_unitaire }}" @endforeach>
                                        </div>
                                    </div>
