                    ...
                    <div class="doc-container">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-12">
                                    ...
                                    <ul class="nav nav-pills inv-list-container d-block" id="pills-tab" role="tablist">
                                        <li class="nav-item">
                                            <div class="nav-link list-actions" id="{{ $facture->reference_facture }}"
                                                data-invoice-id="{{ $facture->reference_facture }}">
                                                <div class="f-m-body">
                                                    <div class="f-head">
                        ...
                        <div class="invoice-container">
                            <div class="invoice-inbox">
                                ...
                                <div id="ct" class="">
                                    <div class="{{ $facture->reference_facture }}">
                                        <div class="content-section  animated animatedFadeInUp fadeInUp">
                                            ...
                                            <div class="row inv--detail-section">
                                                ...
                                                <div class="col-sm-7 align-self-center">
                                                    ...
                                                    <p class="inv-email-address">{{ $facture->client->email }}
                                                    </p>
                                                </div>
                                                <div class="col-sm-5 align-self-center  text-sm-right order-2">
                                                    <p class="inv-list-number"><span class="inv-title">Facture
                                                            Number
                                                            : </span> <span
                                                            class="inv-number">[{{ $facture->reference_facture }}]</span>
                                                    </p>
                                                    <p class="inv-created-date"><span class="inv-title">Date
                                                            démission :
                                                        </span> <span
                                                            class="inv-date">{{ $facture->date_emission }}</span>
                                                    </p>
                                                    <p class="inv-due-date"><span class="inv-title">Date
                                                            d'échéance :
                                                        </span>
                                                        <span class="inv-date">{{ $facture->date_echeance }}</span>
                                                    </p>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="inv--payment-info">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8 col-12">
                                                                <p>
                                                                    {{ implode(' | ', $facture->detailsFacture->map(fn($detail) => $detail->produit->categorie . '; ' . $detail->produit->description)->toArray()) }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
