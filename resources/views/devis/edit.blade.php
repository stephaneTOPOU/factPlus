                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" id="client_id" name="client_id">
                                                ...
                                                @foreach ($clients as $client)
                                                    <option value="{{ $client->id }}" @if ($client->id == $devis->client_id) selected @endif>{{ $client->nom }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row  mb-4">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control form-control-sm"
                                                ...
                                                name="quantite" required @foreach ($devis->detailDevis as $detail) value="{{ old('quantite') ?? $detail->quantite }}" @endforeach>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row  mb-4">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control form-control-sm"
                                                ...
                                                name="prix_unitaire" required @foreach ($devis->detailDevis as $detail) value="{{ old('prix_unitaire') ?? $detail->prix_unitaire }}" @endforeach>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row  mb-4">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control form-control-sm"
                                                ...
                                                name="tva" required @foreach ($devis->detailDevis as $detail) value="{{ old('tva') ?? $detail->tva }}" @endforeach>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row  mb-4">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" id="status" name="status">
                                                ...
                                                <option value="en attente" {{ old('status', $devis->status ?? '') == 'en attente' ? 'selected' : '' }}>en attente</option>
                                                <option value="payée" {{ old('status', $devis->status ?? '') == 'payée' ? 'selected' : '' }}>payée</option>
                                                <option value="annulée" {{ old('status', $devis->status ?? '') == 'annulée' ? 'selected' : '' }}>annulée</option>
                                            </select>
                                        </div>
                                    </div>
