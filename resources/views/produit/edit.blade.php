                                    ...
                                    <div class="form-group row  mb-4">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control form-control-sm" id="nom"
                                                placeholder="Nom du Produit" name="nom" required value="{{ old('nom') ?? $produit->nom }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row  mb-4">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control form-control-sm"
                                                ...
                                                required value="{{ old('prix_unitaire') ?? $produit->prix_unitaire }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row  mb-4">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control form-control-sm"
                                                ...
                                                name="quantite_stock" required value="{{ old('quantite_stock') ?? $produit->quantite_stock }}">
                                        </div>
                                    </div>
